...
%logistic 0
%C = 9501;
user_model = train(genders, trainFeat ,[sprintf('-s 1 -c %f',C)]); %9501
[predicted_label, accuracy, prob_estimates] = predict(genders, trainFeat, user_model, ['-b 1']);
...
[predicted_label, accuracy, prob_estimates] = predict(test_genders, usr_testFeat, user_model,['-b 1']);
