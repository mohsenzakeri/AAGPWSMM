...
%logistic 0
%C = 9501;
user_svm_model = train(genders, trainFeat ,[sprintf('-s 0 -c %f',C)]); %9501
...
[predicted_label, accuracy, prob_estimates] = predict(test_genders, usr_testFeat, user_svm_model,['-b 1']);
